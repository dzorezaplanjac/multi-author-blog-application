...
import { Search, Filter, Loader, PenTool, Plus, UserPlus, Edit } from 'lucide-react';
                    ...
                    {canEditPost(post) && (
                      <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                        <Link
                          ...
                          className="flex items-center justify-center w-10 h-10 bg-white/90 backdrop-blur-sm text-gray-700 hover:text-primary-600 rounded-full shadow-lg hover:shadow-xl transition-all"
                          title="Уреди чланак"
                        >
