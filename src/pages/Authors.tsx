        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
              Упознајте талентоване писце који чувају и преносе богату традицију Запланског краја
            </p>
            
            {/* Call to Action for becoming an author */}
            <div className="bg-primary-50 rounded-xl p-6 mb-8 max-w-2xl mx-auto">
              <h3 className="text-xl font-semibold text-primary-900 mb-2">
                Желите да се придружите нашим ауторима?
              </h3>
              <p className="text-primary-700 mb-4">
                Поделите ваше приче и знање о традицији Запланског краја
              </p>
              <button
